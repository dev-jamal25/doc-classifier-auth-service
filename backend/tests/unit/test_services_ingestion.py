...
def _sample_prediction(batch_id) -> Prediction:
    return Prediction(
        id=uuid4(),
        batch_id=batch_id,
        label="memo",
...
def _sample_audit(batch_id) -> AuditLogEntry:
